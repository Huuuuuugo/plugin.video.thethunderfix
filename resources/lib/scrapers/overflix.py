...
class source:
    ...
    def _extract_embeds_from_page(cls, html):
        ...
        for div in player_divs:
            ...
            getembed = f"https://etv-embed.bond/e/getembed.php?sv={server}&id={player_id}&site=overflix&token={token}"
    ...
    def _get_play_url(cls, referer_url, getembed_url, meta):
        ...
        id_ = meta.get('id')
        sv = meta.get('sv')
        play_url = f"https://etv-embed.bond/e/getplay.php?id={id_}&sv={sv}"
        try:
    ...
    __site_url__ = ['https://overflixtv.dog/']
